...
//Завдання 3: Створіть функцію, що повертає новий об'єкт з тими ж властивостями, що й переданий 
//у якості аргумента об'єкт.
...
function destructureObject(obj) {
  ...
  // Використовуємо деструктуризацію для створення нових змінних з властивостей об'єкту і отримуємо з нього 
  //змінні brand та model
...
function printProductDetails(obj) {
  ...
  console.log(`Product: ${productName}, Price: ${price}, Company: ${companyName}, Country: ${country}`);
...
// Розкоментуйте рядок нижче після виконня завдання для перевірки
 console.log(newArr.customProperty, newArr); // Виведе myProperty
